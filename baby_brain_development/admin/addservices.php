...
<center>
<h1 id="heading" class="text-success">Add Services</h1>
</center>
<form action="addservicesback.php" method="post" onSubmit="del()" enctype="multipart/form-data">

<input id="input" type="text" placeholder="Enter Introducation Heading" name="intro" class="form-control" required>
<textarea id="message" name="introone" placeholder="Enter Services Details" class="form-control" required></textarea>
