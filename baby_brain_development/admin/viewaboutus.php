...
<td><?php echo $row['introone'];?></td>
<td><?php echo $row['introdetails'];?></td>
<td><?php echo $row['firstheading'];?></td>
<td><?php echo $row['firstdetail'];?></td>
<td><?php echo $row['secondheading'];?></td>
<td><?php echo $row['seconddetails'];?></td>


<td><img src="uploadimage/<?php echo $row['image'];?>" style="height:50px;width:50px;margin:10px;"></td>
<td><a href="delaboutus.php?php=<?php echo $row['id']?>"><img src="image/delete.png" style="height:30px;width:30px;margin:10px;" onClick="del()"></a></td>
</tr>
<?php } ?>
</table>
<script>
