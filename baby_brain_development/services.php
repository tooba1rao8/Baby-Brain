...
<h3 style="color:#1A2238;"><?php echo $row['serviceheading'];?></h3>


<p style="line-height:24px;text-indent:30px;text-align:justify;font-size:17px;">
<?php echo $row['servicedetail'];?>
</p>
...
<p style="line-height:24px;text-indent:30px;text-align:justify;font-size:17px;"><?php echo $row['seconddetail'];?></p>
